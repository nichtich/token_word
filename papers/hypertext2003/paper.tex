...
\roundnode{kInAAnchor}(-5.45,.25)[\graphnodecolour{0}\graphnodesize{0.1}]
...
\diredge{AQuote}{AQuoteInB}[\graphlinedash{4 4}\grapharrowtype{2}]
\dirbow{kInAAnchor}{k}{0.17}[\grapharrowtype{1}]

\diredge{BQuote}{BQuoteInC}[\graphlinedash{4 4}\grapharrowtype{2}]
\dirbow{kInBAnchor}{k}{-0.17}[\grapharrowtype{1}]

\diredge{kInC}{k}[\grapharrowtype{1}]
