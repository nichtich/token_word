...
We can look at architecture drawings and pictures of cardboard mock-ups \cite{Nelson1999}, but these do not give us a true sense of what it would be like to use a xanalogical system.  
...
Versioning with this mechanism is particularly space-efficient:  unchanged portions of a new document version can be quoted from the content space instead of being duplicated.
...
In practice, an author will need to read a document before quoting it, but this reading requires the normal first-access payment, no matter how widely the new document is expected to be read.
